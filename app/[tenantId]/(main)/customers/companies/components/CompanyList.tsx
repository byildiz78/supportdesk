...
import { MoreHorizontal, Eye, Edit, Trash2, Building, Mail, Phone, Hash, Building2 } from "lucide-react"
                    ...
                    {isLoading ? (
                        ...
                        <TableRow>
                            <TableCell colSpan={6} className="h-[400px] text-center">
                                <div className="flex flex-col items-center justify-center gap-2">
                                    ...
                                    <p className="text-muted-foreground">Henüz hiç firma kaydı oluşturulmamış.</p>
                                </div>
                            </TableCell>
                        </TableRow>
                    ) : (
                        companies.map((company) => (
                            <TableRow key={company.id} className="group hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                ...
                                <TableCell>{company.mainCompanyName}</TableCell>
