...
import { Save, Building, Building2, Mail, Phone, Hash, FileText } from "lucide-react"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Select
                      value={companyData.mainCompanyId}
                      onValueChange={(value) => setCompanyData(prev => ({ ...prev, mainCompanyId: value }))}
                    >
                      <SelectTrigger className="pl-10">
                        <SelectValue placeholder="Ana firma seçin" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="1">Örnek Ana Firma 1</SelectItem>
                        <SelectItem value="2">Örnek Ana Firma 2</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
