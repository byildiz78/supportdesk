...
import { Company } from "@/types/customers"
import { Building, Building2, Mail, Phone, Hash, FileText, Calendar, User } from "lucide-react"

interface CompanyDetailPageProps {
    companyId: string;
}

export default function CompanyDetailPage({ companyId }: CompanyDetailPageProps) {
        ...
        <div className="flex flex-col space-y-6 p-4">
            ...
            <Card className="p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <Label className="text-muted-foreground">Ana Firma</Label>
                        <div className="mt-1 flex items-center gap-2">
                            <Building2 className="h-4 w-4 text-gray-500" />
                            <span className="text-lg font-medium">{company.mainCompanyName}</span>
                        </div>
                    </div>
                    <div>
