...
export default function AllTicketsPage() {
    ...
    const fetchTickets = useCallback(async () => {
        ...
        try {
            ...
            const response = await axios.post('/api/main/software', {
    ...
    return (
        <div className="flex-1 space-y-4 p-4 md:p-2 pt-2 h-[calc(85vh-4rem)] flex flex-col">
            <TicketHeader 
                title="Yazılım Destek Talepleri" 
                description="Yazılım taleplerini yönetin ve takip edin." 
            />
