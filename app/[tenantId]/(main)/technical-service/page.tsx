...
import { TicketHeader } from "../tickets/components/TicketHeader"
import { TicketFilters } from "../tickets/components/TicketFilters"
import { TicketList } from "../tickets/components/TicketList"
import { TicketPagination } from "../tickets/components/TicketPagination"
...
export default function AllTicketsPage() {
    ...
    const fetchTickets = useCallback(async () => {
        ...
        try {
            ...
            const response = await axios.post('/api/main/technical-service', {
    ...
    return (
        <div className="flex-1 space-y-4 p-4 md:p-2 pt-2 h-[calc(85vh-4rem)] flex flex-col">
            <TicketHeader 
                title="Teknik Servis Destek Talepleri" 
                description="Teknik servis taleplerini yönetin ve takip edin." 
            />
