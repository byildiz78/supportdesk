...
export default function MobileTicketsPage() {
  ...
  const fetchTickets = useCallback(async () => {
    ...
    try {
      ...
      const response = await axios.post('/api/main/call-center', requestParams);
  ...
  return (
    <div className="flex flex-col h-[calc(110vh-4rem)] overflow-hidden">
      ...
      <MobileTicketContainer
        title="Çağrı Merkezi Talepleri"
        description="Çağrı merkezi için destek taleplerini görüntüleyin ve yönetin"
        tickets={tickets}
        isLoading={isLoading}
        error={error}
