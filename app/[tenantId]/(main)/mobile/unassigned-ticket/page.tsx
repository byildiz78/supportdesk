...
export default function MobileTicketsPage() {
  const TAB_NAME = "unassigned-ticket";
  ...
  const fetchTickets = useCallback(async () => {
    ...
    try {
      ...
      const response = await axios.post('/api/main/tickets/unassignedTicketList', requestParams);
  ...
  return (
    <div className="flex flex-col h-[calc(110vh-4rem)] overflow-hidden">
      ...
      <MobileTicketContainer
        ...
        description="Atanmamış destek taleplerini görüntüleyin ve yönetin"
        tickets={tickets}
        isLoading={isLoading}
        error={error}
