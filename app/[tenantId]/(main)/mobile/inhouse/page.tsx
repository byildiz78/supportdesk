...
export default function MobileTicketsPage() {
  ...
  const fetchTickets = useCallback(async () => {
    ...
    try {
      ...
      const response = await axios.post('/api/main/inhouse', requestParams);
  ...
  return (
    <div className="flex flex-col h-[calc(110vh-4rem)] overflow-hidden">
      ...
      <MobileTicketContainer
        ...
        description="Yerinde servis departmanı için destek taleplerini görüntüleyin ve yönetin"
        tickets={tickets}
        isLoading={isLoading}
        error={error}
