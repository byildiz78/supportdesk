...
export default function MobileTicketsPage() {
  const TAB_NAME = "resolved-ticket";
  ...
  const fetchTickets = useCallback(async () => {
    ...
    try {
      ...
      const response = await axios.post('/api/main/tickets/resolved-ticket', requestParams);
  ...
  return (
    ...
    title="Çözülen Talepler"
        description="Çözülen destek taleplerini görüntüleyin ve yönetin"
        tickets={tickets}
        isLoading={isLoading}
        error={error}
